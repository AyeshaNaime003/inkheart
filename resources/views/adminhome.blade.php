...
<body>
    ...
    <div class="btn-container d-flex align-items-center justify-content-between px-4">
        ...
        <a href={{url('/addbook')}}><button class="btn btn-block bg-light-pink m-2">Add New Book</button></a>
    </div>
    <section id="cart">
        <div class="container-fluid py-3 px-2">
            <div class="cart-item row align-items-center">
                ...
                <div class="col-1 col-md remove">
                    <a href={{url('/editbook')}} class="remove-link"><svg xmlns="http://www.w3.org/2000/svg" width="25"
