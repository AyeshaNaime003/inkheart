...
<footer>
      ...
      <div class="row w-100">
          <div class="col-6 col-md-3">
              <a href={{route('homepage')}} class="text-decoration-none text-light text-md-left my-2 d-block text-center">
                <img class="img-fluid logo-img-footer" src="{{url('logos/footerbook.png')}}" alt=""><p class="m-auto text-logo">InkHeart</p></a>
          </div>
          <div class="col-6 col-md-3 text-center col1 p-2">
              ...
              <li><a href={{route('Terms-Conditions')}} class="text-decoration-none">Terms and Conditions</a></li>
              </ul>
          </div>
          <div class="col-6 col-md-3 text-center col2 p-2">
              ...
              <li><a href="{{url('/bestselling')}}" class="text-decoration-none">Best Sellers</a></li>
              <li><a href="{{url('/recent')}}" class="text-decoration-none">Recent in Stock</a></li>
              </ul>
          </div>
          <div class="col-6 col-md-3 text-center col3 p-2">
              <h5 class="m-3">About Us</h5>
              <ul>
              <li><a href={{route('about-business')}} class="text-decoration-none">About the business</a></li>
    ...
    <div class="copyright bg-peach-pink m-0 py-3">
      <p class="text-copyright text-center px-3">Copyright © 2022 InkHeart. The InkHeart is not responsible for the content of external sites. Read about our approach to external linking.</p>
    </div>
  </footer>
  <!-- FOOTER -->
