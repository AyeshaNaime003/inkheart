            ...
            <div class="container-fluid p-0 d-flex justify-content-center">
                <ul class="navbar-nav">
                  <li class="nav-item d-block mx-md-3 px-1">
                    <a class="nav-link active" href="{{url('/display')}}/{{"educative"}}"><h6>Educative</h6></a>
                  </li>
                  <li class="nav-item d-block mx-md-3 px-1">
                    <a class="nav-link active"href="{{url('/display')}}/{{"urdu"}}"><h6>Urdu</h6></a>
                  </li>
                  <li class="nav-item d-block mx-md-3 px-1">
                    <a class="nav-link active" href="{{url('/display')}}/{{"islamic"}}"><h6>Islamic</h6></a>
                  </li>
                  <li class="nav-item d-block mx-md-3 px-1">
                    <a class="nav-link active"href="{{url('/display')}}/{{"leisure"}}"><h6>Leisure</h6></a>
                  </li>
                  <li class="nav-item d-block mx-md-3 px-1">
