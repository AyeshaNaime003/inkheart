            ...
            <div class="row p-0 p-md-4 m-0 my-md-4">
                <div class="col-12 col-md-5">
                    <div class="book-img-container w-100 h-50">
                        <img src="https://www.libertybooks.com/image/cache/catalog/01.iqbal%20ahmed/9781408891384-640x996.jpg?q6"
                            alt="" class="book-img-detail">
                    </div>
                </div>
                <div class="col-12 col-md-7 px-0 px-md-4 ">
                    <input type="text" class="book-details mt-4" value="ISBN" disabled><br>
                    <input type="text" class="book-details" value="Title" disabled><br>
                    <input type="text" class="book-details" value="Author" disabled><br>
                    <input type="text" class="book-details" value="Publisher" disabled><br>
                    <input type="text" class="book-details" value="Publication Date" disabled><br>
                    <input type="text" class="book-details" value="Language" disabled><br>
                    <input type="text" class="book-details" value="Edition" disabled><br>
                ...
                <div class="container text-center mt-4 ">
                    <button type="button" class="btn bg-peach-pink button">Update Record</button>
                </div>
            </div>
        </div>
