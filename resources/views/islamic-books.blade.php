...
<section id="main" class="container-fluid p-0 my-3">
    ...
    <div class="d-flex button-slider button-slider-pink justify-content-around align-items-end g-2 mt-2 row w-100">
        <button class="col-3 col-md">Quran</button>
        <button class="col-3 col-md">Hadith</button>
        <button class="col-3 col-md">Tafseer</button>
        <button class="col-3 col-md">General</button>
        <button class="col-3 col-md">Biography</button>
    </div>
    <!-- books -->
